...
public class Values {
    ...
    public static final int SHOOTER_ACCEL_ENCODER_SIDECAR = 1;
    ...
    public static final int INTAKE_WRIST_VICTOR          = 0;
    public static final int INTAKE_WRIST_VICTOR_SIDECAR  = 0;
}