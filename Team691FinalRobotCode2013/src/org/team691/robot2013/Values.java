...
public class Values {
    ...
    public static final int FL_DRIVE_VICTOR     = 2;
    public static final int BR_DRIVE_VICTOR     = 10;
    public static final int BL_DRIVE_VICTOR     = 1; 
    ...
    public static final double FR_DRIVE_PID_SCALAR = 50.0;
    public static final double FL_DRIVE_PID_SCALAR = 50.0;
    public static final double BR_DRIVE_PID_SCALAR = 50.0;
    public static final double BL_DRIVE_PID_SCALAR = 50.0;
    ...
    public static final int[] SHOOTER_VICTOR_SIDECARS = {SIDECAR_2, SIDECAR_2};
    
    public static final int SHOOTER_ENCODER_A       = 1;
    public static final int SHOOTER_ENCODER_B       = 2;
    public static final int SHOOTER_ENCODER_SIDECAR = SIDECAR_2;
    ...
    public static final int SHOOTER_ACCEL_ENCODER_A       = 3;
    public static final int SHOOTER_ACCEL_ENCODER_B       = 4;
    public static final int SHOOTER_ACCEL_ENCODER_SIDECAR = SIDECAR_2;
    public static final int SHOOTER_ACCEL_ENCODER_DISTANCE_PER_PULSE   = 1;
    public static final boolean SHOOTER_ACCEL_ENCODER_REVERSE = false;
    public static final int[] SHOOTER_ACCEL_ENCODER       = {SHOOTER_ACCEL_ENCODER_SIDECAR, SHOOTER_ACCEL_ENCODER_A, SHOOTER_ACCEL_ENCODER_B, SHOOTER_ACCEL_ENCODER_DISTANCE_PER_PULSE, (SHOOTER_ACCEL_ENCODER_REVERSE ? 1 : 0)};
    
    public static final int[][] SHOOTER_ENCODERS    = {SHOOTER_ENCODER, SHOOTER_ACCEL_ENCODER};
    ...
    public static final int SHOOTER_TILT_ENCODER_SIDECAR = SIDECAR_2;
    ...
    public static final int UPTAKE_VICTOR           = 1;
    public static final int UPTAKE_VICTOR_SIDECAR   = SIDECAR_2;
    ...
    public static final int INTAKE_ARM_ENCODER_SIDECAR = SIDECAR_2;
